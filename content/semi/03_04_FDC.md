...
![Equipment Health Index 대시보드](/content/semi/images/03_04/equipment_health_dashboard.svg)
...
![정상 vs 이상 Trace 비교 — 식각 RF Power 파형](/content/semi/images/03_04/normal_vs_abnormal_trace.png)
...
![PCA 기반 FDC 파이프라인](/content/semi/images/03_04/pca_based_fdc.svg)
...
![Autoencoder 복원 오차 분포 — 정상 vs 이상](/content/semi/images/03_04/autoencoder_reconstruction_error.png)
...
$$
\begin{aligned}
\textbf{Summary}:&\;(\text{Wafer\_ID},\; \text{Equipment\_ID},\; \text{Chamber\_ID},\; \text{Step\_ID}, \\
&\;\text{Sensor\_Name},\; \text{Mean},\; \text{Std},\; \text{Min},\; \text{Max},\; \ldots) \\
\textbf{Trace}:&\;(\text{Wafer\_ID},\; \text{Equipment\_ID},\; \text{Chamber\_ID},\; \text{Step\_ID}, \\
&\;\text{Timestamp},\; \text{Sensor\_1},\; \text{Sensor\_2},\; \ldots,\; \text{Sensor\_N})
\end{aligned}
$$
