                                        ...
                                        return (
                                            <li key={chapter.id}>
                                                <Link
                                                    ...
                                                    onClick={onClose}
                                                    className={`flex items-center gap-2 px-3 py-2 text-sm rounded-lg transition-all duration-200 ${isActive
                                                        ? `${accentClass} font-medium border`
                                                        : 'text-zinc-400 hover:bg-zinc-800/50 hover:text-zinc-200'
                                                    }`}
                                                >
                                                    <span className="flex-1 truncate">{chapter.title.split('—')[0].trim()}</span>
                                                    {chapter.wip && (
                                                        <span className="shrink-0 rounded border border-amber-500/20 bg-amber-500/10 px-1.5 py-0.5 text-[10px] font-medium text-amber-500/90">
                                                            공사중
                                                        </span>
                                                    )}
                                                </Link>
