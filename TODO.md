...
- [x] **Python 등가 코드 누락 점검** — 201개 TS 블록 점검. 정상 122건(63.9%) / 의도적 TS-only(구현부 인용) 8건 / 누락 후보 61건. Part 0 (00_2~00_5) 22건 재분류 결과 _진짜 누락 2건_ (00_2 line 185 `yield*`, 00_3 line 164 Ink) 만 보강. 나머지는 _두 언어 비교 내러티브_ 또는 _인접 Python 짝 + 짧은 설명문 사이_ 로 의도적 분리 — :::tabs 강제 통일은 내러티브 파괴라 부적절. Part 1+ 39건도 동일 기준으로 진짜 누락은 극소수로 추정.
